        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    @string = table.Column<string>(name: "string", type: "text", maxLength: 100, nullable: false),
                    ...
                    string_json_objects = table.Column<List<string>>(type: "text[]", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    ulid = table.Column<string>(type: "text", unicode: false, maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "i_app_table_a58f81",
                table: "app_table",
                column: "string_json_objects")
                .Annotation("Npgsql:IndexMethod", "gin");
