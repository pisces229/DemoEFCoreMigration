...
public class AppTableConfiguration : IEntityTypeConfiguration<AppTable>
{
    public void Configure(EntityTypeBuilder<AppTable> builder)
    {
        ...
        builder.Property(e => e.GuidArray)
            .HasColumnType(DbColumnType.UuidArray)
            .HasDefaultValue(new List<Guid>())
            .Metadata.SetValueComparer(new GuidListComparer());
        ...
        builder
            .HasIndex(e => e.StringArray)
            .HasMethod(DbConstant.MethGin);
        builder
            .HasIndex(e => e.GuidArray)
            .HasMethod(DbConstant.MethGin);
        // if use builder.OwnsOne, need to create index manually
        builder
        ...
        // migrationBuilder.Sql("CREATE INDEX ix_apptable_stringarray ON app_table USING gin (string_array);");
        // migrationBuilder.Sql("CREATE INDEX ix_apptable_guidarray ON app_table USING gin (guid_array);");
