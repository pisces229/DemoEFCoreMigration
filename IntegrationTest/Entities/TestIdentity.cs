...
/// <summary>
/// ASP.NET Core Identity 各表(<see cref="AspUser"/>/<see cref="AspRole"/>/<see cref="AspUserRole"/>/
/// Claim/Login/Token)的 CRUD 全流程驗證。
/// </summary>
[TestClass]
public class TestIdentity : BaseTest
{
    ...
    public async Task Write_User()
    {
        ...
        _logger.LogInformation("{Message}", $"User Id={user.Id}, UserName={user.UserName}, Email={user.Email}");
    }
    ...
    public async Task Update_User()
    {
        ...
        _logger.LogInformation("{Message}", $"Updated User Id={found.Id}, PhoneNumber={found.PhoneNumber}, EmailConfirmed={found.EmailConfirmed}");
    }
    ...
    public async Task Delete_User()
    {
        ...
        _logger.LogInformation("{Message}", $"Deleted {deleted} user(s)");
    }
    ...
    public async Task Write_Role()
    {
        ...
        _logger.LogInformation("{Message}", $"Role Id={role.Id}, Name={role.Name}");
    }
    ...
    public async Task Update_Role()
    {
        ...
        _logger.LogInformation("{Message}", $"Updated Role Id={found.Id}, Name={found.Name}");
    }
    ...
    public async Task Delete_Role()
    {
        ...
        Assert.AreEqual(1, deleted);
        _logger.LogInformation("{Message}", $"Deleted {deleted} role(s)");
    }
    ...
    public async Task Write_UserRole()
    {
        ...
        _logger.LogInformation("{Message}", $"UserRole UserId={userRole.UserId}, RoleId={userRole.RoleId}");
    }
    ...
    public async Task Delete_UserRole()
    {
        ...
        Assert.AreEqual(1, deleted);
        _logger.LogInformation("{Message}", $"Deleted {deleted} user-role(s)");
    }
    ...
    public async Task Write_UserClaim()
    {
        ...
        _logger.LogInformation("{Message}", $"UserClaim Id={claim.Id}, UserId={claim.UserId}, ClaimType={claim.ClaimType}, ClaimValue={claim.ClaimValue}");
    }
    ...
    public async Task Update_UserClaim()
    {
        ...
        _logger.LogInformation("{Message}", $"Updated UserClaim Id={found.Id}, ClaimValue={found.ClaimValue}");
    }
    ...
    public async Task Delete_UserClaim()
    {
        ...
        Assert.AreEqual(1, deleted);
        _logger.LogInformation("{Message}", $"Deleted {deleted} user-claim(s)");
    }
    ...
    public async Task Write_RoleClaim()
    {
        ...
        _logger.LogInformation("{Message}", $"RoleClaim Id={roleClaim.Id}, RoleId={roleClaim.RoleId}, ClaimType={roleClaim.ClaimType}, ClaimValue={roleClaim.ClaimValue}");
    }
    ...
    public async Task Update_RoleClaim()
    {
        ...
        _logger.LogInformation("{Message}", $"Updated RoleClaim Id={found.Id}, ClaimValue={found.ClaimValue}");
    }
    ...
    public async Task Delete_RoleClaim()
    {
        ...
        Assert.AreEqual(1, deleted);
        _logger.LogInformation("{Message}", $"Deleted {deleted} role-claim(s)");
    }
    ...
    public async Task Write_UserLogin()
    {
        ...
        _logger.LogInformation("{Message}", $"UserLogin UserId={login.UserId}, LoginProvider={login.LoginProvider}, ProviderKey={login.ProviderKey}");
    }
    ...
    public async Task Delete_UserLogin()
    {
        ...
        Assert.AreEqual(1, deleted);
        _logger.LogInformation("{Message}", $"Deleted {deleted} user-login(s)");
    }
    ...
    public async Task Write_UserToken()
    {
        ...
        _logger.LogInformation("{Message}", $"UserToken UserId={token.UserId}, LoginProvider={token.LoginProvider}, Name={token.Name}");
    }
    ...
    public async Task Update_UserToken()
    {
        ...
        _logger.LogInformation("{Message}", $"Updated UserToken Value={found.Value}");
    }
    ...
    public async Task Delete_UserToken()
    {
        ...
        Assert.AreEqual(1, deleted);
        _logger.LogInformation("{Message}", $"Deleted {deleted} user-token(s)");
    }
